...
class calcParser ( Parser ):
    ...
    def prog(self):
        ...
        try:
            ...
            while True:
                ...
                self._errHandler.sync(self)
                _la = self._input.LA(1)
                if not ((((_la) & ~0x3f) == 0 and ((1 << _la) & ((1 << calcParser.T__1) | (1 << calcParser.ID) | (1 << calcParser.INT) | (1 << calcParser.NEWLINE))) != 0)):
                    break
    ...
    class BlankContext(StatContext):
        ...
        def NEWLINE(self):
            return self.getToken(calcParser.NEWLINE, 0)
    ...
    def stat(self):
        ...
        try:
            ...
            if la_ == 1:
                localctx = calcParser.PrintExprContext(self, localctx)
                self.enterOuterAlt(localctx, 1)
                self.state = 11
                self.expr(0)
                self.state = 12
                self.match(calcParser.NEWLINE)
                pass
                ...
                localctx = calcParser.BlankContext(self, localctx)
